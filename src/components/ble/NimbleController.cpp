...
NimbleController::NimbleController(Pinetime::System::SystemTask& systemTask,
  ...
  : systemTask {systemTask},
    ...
    heartRateHistoryService {*this, heartRateController},
  ...
  switch (event->type) {
    ...
    case BLE_GAP_EVENT_SUBSCRIBE:
      ...
      if (event->subscribe.reason == BLE_GAP_SUBSCRIBE_REASON_TERM) {
        ...
        heartRateHistoryService.UnsubscribeNotification(event->subscribe.attr_handle);
        ...
        heartRateHistoryService.SubscribeNotification(event->subscribe.attr_handle);
